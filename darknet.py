...
if __name__ == "__main__":
    ...
    carpeta="./data/estudiantes/aves/Aves_Entrenamiento/ArdeaCinerea_GarzaReal/"
    r = detect(net, meta, carpeta+"001.jpg")
    print (r)
    ...
    #imgrecorte=img[y:y+h,x:x+w]
    #cv.imshow('figurina',imgrecorte)
    #cv.waitKey(0)
